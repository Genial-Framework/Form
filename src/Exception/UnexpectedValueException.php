...
namespace Genial\Form\Exception;

use UnexpectedValueException as UnexValException;

/**
 * UnexpectedValueException.
 */
class UnexpectedValueException extends UnexValException implements ExceptionInterface
{
}
